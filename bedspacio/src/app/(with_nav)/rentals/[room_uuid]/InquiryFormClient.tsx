...
//                         <div className='flex items-center justify-between w-full border-b border-dashed border-[#1D242B]/25'>
//                             <span>Room Name: </span>
//                             <span className='text-right'><strong>{payload?.room_name}</strong></span>
//                         </div>
    ...
    const onSubmit = async (data: InquiryFormValues) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                setSubmissionData({
                    inquiry_id: result?.data.inquiry_id,             // FIX: pull direct attributes straight from return
                    reference_number: result?.data.reference_number // FIX: no .data nesting needed here
                });
...
{/* 
                        ...
                        <div className='flex items-center justify-between w-full border-b border-dashed border-[#1D242B]/25'>
                            <span>Room Name: </span>
                            <span><strong>{payload?.room_name}</strong></span>
                        </div>
