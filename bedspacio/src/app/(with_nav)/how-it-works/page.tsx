        ...
        <div className="flex flex-col items-center justify-start min-h-screen w-full">
            ...
            <section className="flex flex-col items-center h-auto w-full px-[1rem] xl:px-[8rem] lg:px-[8rem] md:px-[2rem] py-[4rem] gap-[4rem]">
                <div className="flex flex-col xl:grid lg:grid md:flex xl:grid-cols-2 lg:grid-cols-2 md:flex-col w-full gap-[2rem] xl:max-h-[400px] lg:max-h-[400px]">
                    ...
                    <div className="flex items-center justify-center bg-[#C7EEFF] w-full min-h-[400px] rounded-[10px] border-2 border-[#1D242B] overflow-hidden">
                        image
                    </div>
                </div>
                ...
                <div className="flex flex-col xl:grid lg:grid md:flex xl:grid-cols-2 lg:grid-cols-2 md:flex-col w-full gap-[2rem] xl:h-[400px] lg:h-[400px]">
                    <div className="hidden xl:flex lg:flex items-center justify-center bg-[#C7EEFF] w-full h-auto rounded-[10px] overflow-hidden border-2 border-[#1D242B]">Image</div>
                    <div className="flex flex-col items-center justify-center p-[2rem] gap-[2rem]">
                    ...
                    <div className="flex xl:hidden lg:hidden items-center justify-center bg-[#C7EEFF] w-full min-h-[400px] rounded-[10px] border-2 border-[#1D242B] overflow-hidden ">Image</div>
                </div>
                ...
                <div className="flex flex-col xl:grid lg:grid md:flex xl:grid-cols-2 lg:grid-cols-2 md:flex-col w-full gap-[2rem] xl:max-h-[400px] lg:max-h-[400px]">
                    ...
                    <div className="flex items-center justify-center bg-[#C7EEFF] w-full h-auto min-h-[400px] rounded-[10px] border-2 border-[#1D242B] overflow-hidden">Image</div>
                </div>

                <div className="flex flex-col xl:grid lg:grid md:flex xl:grid-cols-2 lg:grid-cols-2 md:flex-col w-full gap-[2rem] xl:h-[400px] lg:h-[400px]">
                    <div className="hidden xl:flex lg:flex md:flex items-center justify-center bg-[#C7EEFF] w-full h-auto rounded-[10px] overflow-hidden border-2 border-[#1D242B]">Image</div>
                    <div className="flex flex-col items-center justify-center p-[2rem] gap-[2rem]">
                    ...
                    <div className="flex xl:hidden lg:hidden md:hidden items-center justify-center bg-[#C7EEFF] w-full min-h-[400px] rounded-[10px] overflow-hidden border-2 border-[#1D242B]">Image</div>
                </div>
            </section>
        </div>
    )
