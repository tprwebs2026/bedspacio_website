...
export default function InquiryModalWrapper ({ modalOpen, inquiry, onSuccess, onDelete, onArchiveSingle, successMessage, errorMessage }: InquiryModalProps) {
    ...
    const [targetMoveIn, setTargetMoveIn] = useState<string>(inquiry.target_move_in)
    const [monthsOfStay, setMonthsOfStay] = useState<number>(inquiry.months_of_stay);
                                ...
                                <>
                                    ...
                                    <div className="flex flex-col items-start w-full">
                                        ...
                                        {!targetMoveInEditing ? (
                                            ...
                                            <div className="flex items-center justify-between w-full py-2 px-3 rounded-[10px] border border-[#1D242B]/25 focus-within:border-[#0077C0]">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button className="text-[14px] font-bold opacity-50 hover:opacity-100 active:opacity-50 transition-all duration-100 cursor-pointer">Update</button>
                                                    <button onClick={() => setTargetMoveInEditing(false)} className="text-[14px] font-bold opacity-50 hover:opacity-100 active:opacity-50 transition-all duration-100 cursor-pointer">Cancel</button>
                                                </div>
                                            </div>
                                        )}
                                    ...
                                    <div className="flex flex-col items-start w-full">
                                        ...
                                        {!monthsOfStayEditing ? (
                                            ...
                                            <div className="flex items-center justify-between w-full py-2 px-3 rounded-[10px] border border-[#1D242B]/25 focus-within:border-[#0077C0]">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button className="text-[14px] font-bold opacity-50 hover:opacity-100 active:opacity-50 transition-all duration-100 cursor-pointer">Update</button>
                                                    <button onClick={() => setMonthsOfStayEditing(false)} className="text-[14px] font-bold opacity-50 hover:opacity-100 active:opacity-50 transition-all duration-100 cursor-pointer">Cancel</button>
                                                </div>
                                            </div>
                                        )}
