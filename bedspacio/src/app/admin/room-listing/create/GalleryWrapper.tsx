...
export default function GalleryWrapper ({images, setImages }: GalleryWrapperProps) {
        ...
        <div className="flex w-full h-fit">
            <div className="flex flex-col bg-[#1D242B]/10 rounded-[10px] p-[1rem] gap-[1rem] w-full">
                <div className="flex flex-col items-center justify-center w-full rounded-[10px] gap-2">
                    <label htmlFor="add_image" className={`flex items-center justify-center rounded-[10px] w-full py-[2rem] border-2 border-dashed border-[#1D242B]/25  bg-[#C7EEFF]/50 ${images.length >= 6 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#0077C0]/30 active:bg-[#C7EEFF]/50 cursor-pointer'}`}>
