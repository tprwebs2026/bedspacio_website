...
export default function RoomType () {
    ...
    return (
        <div className="flex flex-col xl:flex-row lg:flex-row md:flex-row items-center justify-center gap-[1rem] w-full p-3">
            <div className='group relative flex items-center justify-center w-full h-[200px] xl:h-[337.5px] lg:h-[337.5px] bg-[#1D242B] border-2 border-[#1D242B]/80 rounded-[10px] overflow-hidden'>
